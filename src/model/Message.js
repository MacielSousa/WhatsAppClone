...
export class Message extends Model{
    ...
    get tipeStamp(){ return this._data.tipeStamp; }
    set tipeStamp(value) { return this._data.tipeStamp = value }
    ...
    getViewElement(me = true){
                            ...
                            <div class="_3DZ69" role="button">
                                ...
                                <div class="_3a5-b">
                                    <div class="_1DZAH" role="button">
                                        <span class="message-time">${Format.timeStampToTime(this.tipeStamp)}</span>
                        ...
                        <div class="_2jfIu">
                            <div class="_2cfqh">
                                <div class="_1QMEq _1kZiz fS1bA">
                                    ...
                                    <div class="_1_Gu6">
                                        <div class="message-audio-duration">${Format.timeStampToTime(this.tipeStamp)}</div>
                                        <div class="_1sLSi">
        ...
        if(me){
            ...
            div.querySelector('.message-time').parentElement.appendChild(this.getStatusViewElemnets());
        }
            ...
            Message.upload(file, from).then(downloadURL => {
                ...
                if(filePreview){
                    ...
                    Message.upload(filePreview, from).then(downloadURL2 => {
                        ...
                        let downloadFilePreview = downloadURL2;
